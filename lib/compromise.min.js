!(function (e, t) {
  ...
  class View {
    ...
    get docs() {
      let t = this.document;
      return (
        this.ptrs && (t = e.methods.one.getDoc(this.ptrs, this.document)),
        t
      );
    }
    get pointer() {
    ...
    get fullPointer() {
      ...
      return r.map((e) => {
        ...
        return (
          ...
          n[t] &&
            n[t][r] &&
            ((a = a || n[t][r].id), n[t][o - 1] && (i = i || n[t][o - 1].id)),
          [t, r, o, a, i]
        );
      });
    }
    update(e) {
      ...
      if (this._cache && e && e.length > 0) {
        ...
        (e.forEach((e, t) => {
          const [r, o, a] = e;
          (1 === e.length || (0 === o && this.document[r].length === a)) &&
            (n[t] = this._cache[r]);
        }),
  ...
  const s = function (e, t, n, r) {
      if (((o = e), "[object Array]" === Object.prototype.toString.call(o)))
    ...
    u = function (e, t, n) {
      const { methods: r } = n,
        o = new t([]);
      if (((o.world = n), "number" == typeof e && (e = String(e)), !e))
        return o;
      if ("string" == typeof e) {
    ...
    y = (e, t, n) => {
      ...
      if (r.test(a)) {
        const e = a.match(r).join(""),
          t = n[n.length - 1];
        ((t.post = e + t.post), (o.post = o.post.replace(r, "")));
      }
    },
    w = function (e, t, n, r) {
      const [o, a, i] = t;
      (0 === a || i === r[o].length ? v(n) : (v(n), v([e[t[1]]])),
        (function (e, t, n) {
          const r = e[t];
          if (0 !== t || !f(r.text)) return;
          n[0].text = n[0].text.replace(/^\p{Ll}/u, (e) => e.toUpperCase());
          const o = e[t];
          o.tags.has("ProperNoun") ||
            o.tags.has("Acronym") ||
            (f(o.text) &&
              o.text.length > 1 &&
              (o.text =
                ((a = o.text), a.replace(/^\p{Lu}/u, (e) => e.toLowerCase()))));
          var a;
        })(e, a, n),
        b(e, a, n));
    };
  ...
  ((T.replaceWith = function (e, t = {}) {
    ...
    const a = t.possessives && o[o.length - 1].tags.has("Possessive"),
      i =
        t.case &&
        ((s = o[0].text), /^\p{Lu}[\p{Ll}'’]/u.test(s) || /^\p{Lu}$/u.test(s));
    var s;
    e = (function (e, t) {
  ...
  var B = {
    ...
    sort: function (e) {
      ...
      return (
        ...
        z.has(e) && (e = "alpha"),
        V.has(e)
          ? ((o = O.byFreq(o)), this.update(o.map((e) => e.pointer)))
          : "function" == typeof O[e]
            ? ((o = o.sort(O[e])), this.update(o.map((e) => e.pointer)))
            : this
      );
    },
  };
  ...
  const oe = /^([0-9.]{1,4}[a-z]{0,2}) ?[-–—] ?([0-9]{1,4}[a-z]{0,2})$/i,
    ...
    se = function (e, t) {
      ...
      return null !== r
        ? !0 === n.tags.has("PhoneNumber") || ie.test(n.text)
          ? null
          : [r[1], "to", r[2]]
        : ((r = n.text.match(ae)), null !== r ? [r[1], "to", r[4]] : null);
    },
    le = /^([+-]?[0-9][.,0-9]*)([a-z°²³µ/]+)$/,
    ue = function (e, t, n) {
    ...
    pe = function (e, t, n, r) {
      for (let o = 0; o < e.length; o += 1) {
        const a = e[o];
        if (a.word === t.normal) return a.out;
        if (null !== r && r === a.after) return [n].concat(a.out);
              ...
              : he.test(r[s].normal)
                ? ((c = se(r, s)),
                  c &&
                    ...
                    c[2] &&
                      c[2].tags.has("Time") &&
                      o.one.setTag([c[0]], "Time", t, null, "time-range"),
                    de(n[i], e, s, c.length)))
                : ((c = ue(r, s, t)),
                  c &&
                    ((c = fe(c, e)),
        ...
        for (let n = 0; n < e.length; n += 1) {
          ...
          if (void 0 !== i[s] && e[n + 1]) {
            for (let r = n + i[s] - 1; r > n; r -= 1) {
              ...
              !0 !== a.hasOwnProperty(s) ||
                (o(i, a[s], t, !1, "1-frozen-multi-lexicon"),
                i.forEach((e) => (e.frozen = !0)));
            }
          }
          void 0 !== a[s] &&
            a.hasOwnProperty(s) &&
            (o([r], a[s], t, !1, "1-freeze-lexicon"), (r.frozen = !0));
        }
      });
    };
  const ke = (e) => "[34m" + e + "[0m",
  ...
  const Ne = function (e, t, n) {
      ...
      if (void 0 !== i[u] && e[t + 1]) {
        for (let r = t + i[u] - 1; r > t; r -= 1) {
          ...
          if (!0 === s.hasOwnProperty(i)) {
            const e = s[i];
            return (
              a(o, e, n, !1, "1-multi-lexicon"),
              !e ||
                2 !== e.length ||
                ("PhrasalVerb" !== e[0] && "PhrasalVerb" !== e[1]) ||
                a([o[1]], "Particle", n, !1, "1-phrasal-particle"),
              !0
            );
          }
        }
    ...
    Ie = function (e, t, n) {
      ...
      if (void 0 !== i[l] && i.hasOwnProperty(l))
        return (a([s], i[l], n, !1, "1-lexicon"), !0);
      if (s.alias) {
        const e = s.alias.find((e) => i.hasOwnProperty(e));
        if (e) return (a([s], i[e], n, !1, "1-lexicon-alias"), !0);
      }
      if (!0 === je.test(l)) {
        const e = l.replace(je, "");
        if (i.hasOwnProperty(e) && e.length > 3 && xe.has(i[e]))
          return (a([s], i[e], n, !1, "1-lexicon-prefix"), !0);
      }
      return null;
    };
  var Te = {
  ...
  var He = {
    addWords: function (e, t = !1) {
      ...
      if (r.two.expandLexicon) {
        ...
        (Object.assign(o.one.lexicon, t), Object.assign(o.one._multiCache, a));
      }
  ...
  const Ge = function (e, t) {
      ...
      e.forEach(function (e) {
        ...
        for (let e = 0; e < a.length; e++) {
          const t = a[e];
          n[o] && n[o].hasOwnProperty(t)
            ? (o = n[o][t])
            : (i++, (n[o][t] = i), (n[i] = {}), (o = i), (r[i] = null));
        }
        r[o] = [a.length];
      });
      for (const e in n[0]) ((i = n[0][e]), (o[i] = 0), a.push(i));
      for (; a.length; ) {
        const e = a.shift(),
          t = Object.keys(n[e]);
        for (let s = 0; s < t.length; s += 1) {
          const l = t[s],
            u = n[e][l];
          for (a.push(u), i = o[e]; i > 0 && !n[i].hasOwnProperty(l); )
            i = o[i];
      ...
      e.prototype.lookup = function (e, t = {}) {
        ...
        let r = (function (e, t, n) {
          ...
          for (let i = 0; i < o.length; i++) {
            if (e._cache && e._cache[i] && !0 === Fe(a, e._cache[i])) continue;
            const s = o[i],
              l = Oe(s, t, n);
  ...
  var We = {
    matchOne: function (e, t, n) {
      ...
      const o = { regs: (e = Me(e, n, this.world)), group: t, justOne: !0 },
    ...
    match: function (e, t, n) {
      ...
      const o = { regs: (e = Me(e, n, this.world)), group: t },
        a = r.match(this.docs, o, this._cache),
        { ptrs: i, byGroup: s } = $e(a, this.fullPointer),
        l = this.toView(i);
      return ((l._groups = s), l);
    ...
    if: function (e, t, n) {
      ...
      if (Je(e)) {
        const t = this.sweep(e, { tagger: !1 }).view.settle();
        return this.if(t);
      }
      const o = { regs: (e = Me(e, n, this.world)), group: t, justOne: !0 };
      ...
      return (this._cache && (s._cache = a.map((e) => i[e[0]])), s);
    },
    ifNo: function (e, t, n) {
      ...
      const a = this._cache || [],
        i = this.filter((n, r) => {
          const i = { regs: e, group: t, justOne: !0 };
          return 0 === o.match(n.docs, i, a[r]).ptrs.length;
        });
      return (this._cache && (i._cache = i.ptrs.map((e) => a[e[0]])), i);
    },
  };
  var qe = {
    ...
    growLeft: function (e, t, n) {
      ...
      return (
        this.forEach((n, o) => {
          ...
          if (a.found) {
            const e = a.terms();
            ((r[o][1] -= e.length), (r[o][3] = e.docs[0][0].id));
          }
        }),
        this.update(r)
      );
      ...
      splitBefore: function (e, t) {
        ...
        for (let e = 0; e < o.length; e += 1)
          !o[e].after &&
            ...
            o[e + 1].before &&
            o[e].match &&
            o[e].match[0] === o[e + 1].before[0] &&
            ((o[e].after = o[e + 1].before), delete o[e + 1].before);
        let a = [];
        return (
          o.forEach((e) => {
            (a.push(e.passthrough),
      ...
      splitAfter: function (e, t) {
        ...
        return (
          o.forEach((e) => {
            (a.push(e.passthrough),
              e.before && e.match
                ? a.push(Ue(e.before, e.match))
                : (a.push(e.before), a.push(e.match)),
              a.push(e.after));
          }),
          (a = a.filter((e) => e)),
          (a = a.map((e) => Qe(e, this))),
  ...
  const tt = /(?:^|\s)([![^]*(?:<[^<]*>)?\/.*?[^\\/]\/[?\]+*$~]*)(?:\s|$)/,
      ...
      return (
        (e = (function (e) {
          ...
          for (let r = 0; r < e.length; r++) {
            const o = e[r];
            (!0 === o.groupStart &&
              ((n = o.group), null === n && ((n = String(t)), (t += 1))),
              null !== n && (o.group = n),
              !0 === o.groupEnd && (n = null));
          }
          return e;
    ...
    At = function (e, t, n = 3) {
      ...
      const r = (function (e, t) {
          ...
          if (0 === r) return n;
          const o = (r > n ? r : n) + 1;
          if (Math.abs(n - r) > (o || 100)) return o || 100;
          const a = [];
          for (let e = 0; e < o; e++) ((a[e] = [e]), (a[e].length = o));
          for (let e = 0; e < o; e++) a[0][e] = e;
          let i, s, l, u, c, h;
          for (let o = 1; o <= n; ++o)
            for (s = e[o - 1], i = 1; i <= r; ++i) {
              if (o === i && a[o][i] > 4) return n;
              ((l = t[i - 1]),
                (u = s === l ? 0 : 1),
                (c = a[o - 1][i] + 1),
                (h = a[o][i - 1] + 1) < c && (c = h),
  ...
  const Ht = function (e, t) {
    ...
    Gt = function (e) {
      ...
      if (void 0 !== n.min && r - e.t < n.min) return null;
      if (void 0 !== n.max && r - e.t > n.max) return ((e.t = e.t + n.max), !0);
      if (!0 === e.hasGroup) {
    ...
    Ot = function (e, t = 0) {
      ...
      for (let a = 0; a < n.choices.length; a += 1) {
        const i = n.choices[a];
        if (((o = i), "[object Array]" !== Object.prototype.toString.call(o)))
          return !1;
        if (
          ((r = i.every((n, r) => {
            let o = 0;
            const a = e.t + r + t + o;
            if (void 0 === e.terms[a]) return !1;
    ...
    zt = function (e) {
      const { regs: t } = e,
        ...
        r = Object.assign({}, n);
      r.negative = !1;
      if (Dt(e.terms[e.t], r, e.start_i + e.t, e.phrase_length)) return !1;
      if (n.optional) {
        const n = t[e.r + 1];
        if (n) {
          if (Dt(e.terms[e.t], n, e.start_i + e.t, e.phrase_length)) e.r += 1;
          else if (n.optional && t[e.r + 2]) {
            Dt(e.terms[e.t], t[e.r + 2], e.start_i + e.t, e.phrase_length) &&
              (e.r += 2);
          }
        }
      }
      return n.greedy
        ? (function (e, t, n) {
            ...
            for (let o = e.t; o < e.terms.length; o += 1) {
              ...
              if (
                n &&
                ((a = Dt(e.terms[o], n, e.start_i + e.t, e.phrase_length)), a)
              )
                break;
    ...
    Bt = function (e) {
      ...
      return (
        (e.t = (function (e, t) {
          const n = Object.assign({}, e.regs[e.r], { start: !1, end: !1 }),
            r = e.t;
          for (; e.t < e.terms.length; e.t += 1) {
            if (t && Dt(e.terms[e.t], t, e.start_i + e.t, e.phrase_length))
              return e.t;
            const o = e.t - r + 1;
            if (void 0 !== n.max && o === n.max) return e.t;
    ...
    St = function (e) {
      const { regs: t } = e,
        ...
        r = e.terms[e.t],
        o = e.t;
      if (n.optional && t[e.r + 1] && n.negative) return !0;
      if (
        (n.optional &&
          t[e.r + 1] &&
          (function (e) {
    ...
    $t = function (e, t, n, r) {
      ...
      for (; o.r < t.length; o.r += 1) {
        const e = t[o.r];
        if (
          ((o.hasGroup = Boolean(e.group)),
          !0 === o.hasGroup ? (o.inGroup = e.group) : (o.inGroup = null),
          !o.terms[o.t])
        ) {
          if (!1 === t.slice(o.r).some((e) => !e.optional)) break;
          return null;
        }
      ...
      const i = {};
      return (
        Object.keys(o.groups).forEach((e) => {
          const t = o.groups[e],
            r = n + t.start;
            ...
            (r = (function (e, t) {
              ...
              for (let t = e.length - 1; t >= 0; t -= 1) {
                ...
                if (r.word && ft.test(r.word)) {
                  ...
                  if (n.hasOwnProperty(o[0])) continue;
                  ((o = o.filter((e) => e).reverse()),
                    e.splice(t, 1),
                    o.forEach((n) => {
                      const o = Object.assign({}, r);
                      ((o.word = n), e.splice(t, 0, o));
                    }));
                }
              }
              return e;
            ...
            if (!n[t] || !Pt(r, n[t]))
              if (!0 !== r[0].start)
                for (let e = 0; e < o.length; e += 1) {
                  ...
                  if (l) {
                    if (((l = Mt(l, t)), i.push(l), !0 === a)) break e;
                    const n = l.pointer[2];
  ...
  const on = function (e) {
      let t,
        n,
        r,
        o = decodeURI(encodeURI(e)) + "",
        a = o.length;
      const i = [(t = 1732584193), (n = 4023233417), ~t, ~n],
        s = [];
      for (e = (--a / 4 + 2) | 15, s[--e] = 8 * a; ~a; )
      ...
      out: function (e) {
        ...
        if ("freq" === e || "frequency" === e || "topk" === e)
          return (function (e) {
            ...
            const n = Object.keys(t).map((e) => ({ normal: e, count: t[e] }));
              ...
              (u &&
                ...
                (c = (function (e, t) {
                  ...
                  return (
                    -1 === i
                      ? ((e[2] = t[n].length),
                        (e[4] = a.length ? a[a.length - 1].id : null))
                      : (e[2] = i),
                    t[n].slice(r, e[2] + 1)
                  );
                })(r, t)),
  ...
  const Cn = function (e, t) {
      ...
      return (
        n.forEach((e) => {
          const [t] = e;
          if (1 === r[t].length) return void o.push(e);
      ...
      bulkMatch: function (e, t, n, r = {}) {
        ...
        let a = (function (e, t) {
          return e.map((n, r) => {
            ...
            return (
              (o = o.filter(
                (e) => "boolean" != typeof a[e.match] && ((a[e.match] = !0), !0)
              )),
              o
            );
          });
          ...
          for (let n = 0; n < e.length; n += 1)
            for (let i = 0; i < e[n].length; i += 1) {
              ...
              if (
                ...
                (l.ptrs.forEach((e) => {
                  e[0] = n;
                  const t = Object.assign({}, s, { pointer: e });
      ...
      bulkTagger: function (e, t, n) {
        ...
        return (
          ...
          e.map((e) => {
            ...
            if (void 0 !== e.tag) {
              if (
                (i(u, e.tag, n, e.safe, `[post] '${o}'`), "Noun" === e.tag && l)
              ) {
          ...
          (!1 !== t.tagger && o.one.bulkTagger(a, r, this.world),
            (a = a.map((e) => {
              const t = e.pointer,
                ...
                o = t[2] - t[1];
              return (
                n.index && (e.pointer = [n.index[0], n.index[1], t[1] + o]),
                e
              );
            })));
        ...
        (i &&
          ...
          ((e, t, n = "") => {
            ...
            ("string" != typeof t &&
              ...
              console.log(
                ` ${((o = r), "[33m[3m" + o + "[0m").padEnd(24)} [32m→[0m #${t.padEnd(22)}  ${((e) => "[3m" + e + "[0m")(n)}`
              ));
          })(e, t, o),
        !0 != ((s = t), "[object Array]" === Object.prototype.toString.call(s)))
      )
        if ("string" == typeof t)
          if (((t = t.trim()), On.test(t)))
            !(function (e, t, n, r) {
              ...
              e.forEach((e, t) => {
                let a = o[t];
                a && ((a = a.replace(/^#/, "")), Vn(e, a, n, r));
              });
            })(e, t, a, r);
          else {
            t = t.replace(/^#/, "");
            for (let n = 0; n < e.length; n += 1) Vn(e[n], t, a, r);
          }
    ...
    ar = {
      tag: function (e, t = "", n) {
        ...
        return (
          !0 === a && console.log(" +  ", e, t || ""),
          or(e)
            ? e.forEach((e) => o.one.setTag(r, e, i, n, t))
      ...
      unTag: function (e, t) {
        ...
        return (
          or(e) ? e.forEach((e) => r.one.unTag(n, e, i)) : r.one.unTag(n, e, i),
          this.uncache(),
          this
        );
      },
  ...
  var ir = {
    addTags: function (e) {
      const { model: t, methods: n } = this.world(),
        r = t.one.tagSet,
        o = (0, n.one.addTags)(e, r);
      return ((t.one.tagSet = o), this);
    },
  };
  ...
  const ur = /([.!?\u203D\u2E18\u203C\u2047-\u2049\u3002]+\s)/g,
    ...
    Ar = function (e, t) {
      ...
      if (1 === n[0].length && /[a-z]/i.test(n[0])) return !1;
      if (r.hasOwnProperty(n[0])) return !1;
      if (((n[1] = n[1].trim().replace(/[.?!]$/, "")), o.hasOwnProperty(n[1])))
        return !1;
      if (
        !0 ===
      ...
      tokenize: {
        splitSentences: function (e, t) {
          ...
          for (let e = 1; e < r.length; e += 1) {
            ...
            null !== t && ((r[e - 1] += t[0]), (r[e] = r[e].replace(Pr, "")));
          }
          return r;
        },
        isSentence: function (e, t) {
          if (!1 === Lr.test(e)) return !1;
          if (!0 === $r.test(e)) return !1;
          if (3 === e.length && Jr.test(e)) return !1;
          if (!0 === Mr.test(e)) return !1;
          const n = e
              .replace(/[.!?\u203D\u2E18\u203C\u2047-\u2049] *$/, "")
              .split(" "),
        ...
        splitTerms: function (e, t) {
          ...
          for (let e = 0; e < r.length; e++) {
            const t = r[e];
            !0 === jr.test(t) &&
            !1 === Tr.hasOwnProperty(t) &&
            !1 === xr.test(t)
              ? (n.length > 0
                  ? ((n[n.length - 1] += a), n.push(t))
                  : n.push(a + t),
                (a = ""))
              : (a += t);
          }
          return (
            a && (0 === n.length && (n[0] = ""), (n[n.length - 1] += a)),
            (n = (function (e) {
        ...
        splitWhitespace: (e, t) => {
          const {
            ...
            for (let e = 0; e < u; e += 1) {
              const e = l[0];
              if (!0 !== n[e]) {
                if (("+" === e || "-" === e) && Hr.test(l[1])) break;
                if ("'" === e && 3 === e.length && Hr.test(l[1])) break;
                if (Dr.test(e) || Hr.test(e)) break;
                i += l.shift();
              }
            }
            u = l.length;
          ...
          return { text: n, pre: r, post: o, tags: new Set() };
        },
  ...
  const _r = /\//,
    ...
    ro = function (e, t) {
      ...
      for (let r = 0; r < n.length; r += 1)
        for (let o = 0; o < n[r].length; o += 1) t(n[r][o], e.world);
    },
    oo = {
      alias: (e) => ro(e, eo),
      machine: (e) => ro(e, no),
          ...
          e.forEach((e) => {
            ...
            for (let s = t.min; s < i; s += 1) {
              ...
              (t.safe && n.model.one.lexicon.hasOwnProperty(i)) ||
                (!0 !== a.hasOwnProperty(i) && !0 !== r.hasOwnProperty(i)
                  ? (r[i] = e)
                  : o.push(i));
            }
          }),
  ...
  var bo = function (e) {
    if (void 0 !== fo[e]) return fo[e];
    let t = 0,
      n = 1,
      r = mo,
      o = 1;
    for (; n < e.length; t += r, n++, r *= mo);
    for (let n = e.length - 1; n >= 0; n--, o *= mo) {
  ...
  const ko = {
      ...
      const o = (function (e) {
        ...
        if (!0 === ko.hasOwnProperty(t))
          for (let n = 0; n < ko[t].length; n += 1) {
            const r = ko[t][n][0];
            if (!0 === r.test(e)) return e.replace(r, ko[t][n][1]);
          }
        return null;
      })(e);
    ...
    jo = {},
    xo = { two: { irregularPlurals: ho, uncountable: {} } };
  ...
  const Do = "Infinitive";
  var Ho = {
    beforeTags: { Modal: Do, Adverb: Do, Negative: Do, Plural: Do },
    afterTags: {
      Determiner: Do,
      Adverb: Do,
      Possessive: Do,
  ...
  const Eo = {
    ...
    Go = "Adjective";
  var Oo = {
    beforeTags: { Determiner: Go, Possessive: Go, Hyphenated: Go },
    afterTags: { Adjective: Go },
    beforeWords: {
      seem: Go,
      seemed: Go,
      seems: Go,
    ...
    afterWords: { too: Go, also: Go, or: Go, enough: Go, as: Go },
  };
  const Fo = "Gerund";
  var Vo = {
    beforeTags: { Adverb: Fo, Preposition: Fo, Conjunction: Fo },
    afterTags: {
      Adverb: Fo,
      Possessive: Fo,
      Person: Fo,
  ...
  const zo = "Gerund",
    ...
    So = {
      ...
      afterTags: Object.assign({}, Oo.afterTags, Vo.afterTags, { Noun: Bo }),
  ...
  const qo = { afterTags: { Noun: "Adjective", Conjunction: void 0 } },
    Uo = {
    ...
    na = "Person";
  var ra = {
    beforeTags: { Honorific: na, Person: na },
    afterTags: { Person: na, ProperNoun: na, Verb: na },
    beforeWords: { hi: na, hey: na, yo: na, dear: na, hello: na },
    afterWords: {
      said: na,
      says: na,
      told: na,
  ...
  const oa = "Month",
    aa = {
      beforeTags: { Date: oa, Value: oa },
      afterTags: { Date: oa, Value: oa },
      beforeWords: {
        by: oa,
        in: oa,
        on: oa,
      ...
      afterWords: { sometime: oa, in: oa, of: oa, until: oa, the: oa },
    };
  var ia = {
  ...
  const sa = "Place",
    la = {
      beforeTags: { Place: sa },
      afterTags: { Place: sa, Abbreviation: sa },
      beforeWords: { in: sa, by: sa, near: sa, from: sa, to: sa },
      afterWords: {
        in: sa,
        by: sa,
        near: sa,
    ...
    ca = {
      ...
      "Unit|Noun": {
        ...
        afterWords: { per: ua, squared: ua, cubed: ua, long: ua },
      },
    },
    ha = (e, t) => {
      const n = Object.keys(e).reduce(
        (t, n) => (
          (t[n] = "Infinitive" === e[n] ? "PresentTense" : "Plural"),
          t
        ),
        {}
      );
  ...
  var ja = [
    null,
    null,
    { ea: pa, ia: ka, ic: da, ly: ba, "'n": wa, "'t": wa },
    {
      oed: fa,
      ued: fa,
      xed: fa,
    ...
    { chester: Ca, logists: ya, opoulos: Pa, borough: Ca, sdottir: Pa },
  ];
  const xa = "Adjective",
    Ia = "Noun",
    Ta = "Verb";
  var Da = [
    ...
    null,
    {},
    { neo: Ia, bio: Ia, "de-": Ta, "re-": Ta, "un-": Ta, "ex-": Ia },
    {
      anti: Ia,
      auto: Ia,
      faux: xa,
  ...
  var La = {
    a: [
      [/.[aeiou]na$/, $a, "tuna"],
      [/.[oau][wvl]ska$/, Ma],
      [/.[^aeiou]ica$/, Oa, "harmonica"],
      [/^([hyj]a+)+$/, za, "haha"],
    ],
    c: [[/.[^aeiou]ic$/, Ha]],
    d: [
      [/[aeiou](pp|ll|ss|ff|gg|tt|rr|bb|nn|mm)ed$/, Fa, "popped"],
      [/.[aeo]{2}[bdgmnprvz]ed$/, Fa, "rammed"],
      [/.[aeiou][sg]hed$/, Fa, "gushed"],
      [/.[aeiou]red$/, Fa, "hired"],
      [/.[aeiou]r?ried$/, Fa, "hurried"],
      [/[^aeiou]ard$/, Oa, "steward"],
      [/[aeiou][^aeiou]id$/, Ha, ""],
      [/.[vrl]id$/, Ha, "livid"],
      [/..led$/, Fa, "hurled"],
      [/.[iao]sed$/, Fa, ""],
      [/[aeiou]n?[cs]ed$/, Fa, ""],
      [/[aeiou][rl]?[mnf]ed$/, Fa, ""],
      [/[aeiou][ns]?c?ked$/, Fa, "bunked"],
      [/[aeiou]gned$/, Fa],
      [/[aeiou][nl]?ged$/, Fa],
      [/.[tdbwxyz]ed$/, Fa],
      [/[^aeiou][aeiou][tvx]ed$/, Fa],
      [/.[cdflmnprstv]ied$/, Fa, "emptied"],
    ],
    e: [
      [/.[lnr]ize$/, Ea, "antagonize"],
      [/.[^aeiou]ise$/, Ea, "antagonise"],
      [/.[aeiou]te$/, Ea, "bite"],
      [/.[^aeiou][ai]ble$/, Ha, "fixable"],
      [/.[^aeiou]eable$/, Ha, "maleable"],
      [/.[ts]ive$/, Ha, "festive"],
      [/[a-z]-like$/, Ha, "woman-like"],
    ],
    h: [
      [/.[^aeiouf]ish$/, Ha, "cornish"],
      [/.v[iy]ch$/, Ma, "..ovich"],
      [/^ug?h+$/, za, "ughh"],
      [/^uh[ -]?oh$/, za, "uhoh"],
      [/[a-z]-ish$/, Ha, "cartoon-ish"],
    ],
    ...
    l: [
      ...
      [/.[^aeiou]ful$/, Ha, "fitful"],
      [/.[nrtumcd]al$/, Ha, "natal"],
      [/.[^aeiou][ei]al$/, Ha, "familial"],
    ],
    m: [
      [/.[^aeiou]ium$/, Oa, "magnesium"],
      [/[^aeiou]ism$/, Oa, "schism"],
      [/^[hu]m+$/, za, "hmm"],
      [/^\d+ ?[ap]m$/, "Date", "3am"],
    ],
    n: [
      [/.[lsrnpb]ian$/, Ha, "republican"],
      [/[^aeiou]ician$/, Ba, "musician"],
  ...
  const Xa = function (e = "", t = {}) {
        ...
        (n =
          ...
          (function (e, t, n = {}) {
            ...
            for (let r = e.length - 1; r >= 1; r -= 1) {
              ...
              if (!0 === t.hasOwnProperty(a)) return e.slice(0, o) + t[a];
              if (!0 === n.hasOwnProperty(a)) return e.slice(0, o) + n[a];
            }
    ...
    ei = function (e = {}) {
      return { reversed: !0, both: Ya(e.both), ex: Ya(e.ex), fwd: e.rev || {} };
    },
    ti = /^([0-9]+)/,
    ni = function (e) {
      let t = (function (e) {
  ...
  const vi = function (e, t) {
    const { irregularPlurals: n } = t.two,
      r = ((o = n), Object.keys(o).reduce((e, t) => ((e[o[t]] = t), e), {}));
    var o;
    if (r.hasOwnProperty(e)) return r[e];
    for (let t = 0; t < bi.length; t++)
      if (!0 === bi[t][0].test(e)) return (e = e.replace(bi[t][0], bi[t][1]));
    return e;
  };
  var yi = {
    toPlural: Ao,
  ...
  wi = Object.keys(wi).reduce(
    (e, t) => (wi[t].forEach((n) => (e[n] = t)), e),
    {}
  );
  const ki = function (e) {
      const t = e.substring(e.length - 3);
      if (!0 === wi.hasOwnProperty(t)) return wi[t];
      const n = e.substring(e.length - 2);
      if (!0 === wi.hasOwnProperty(n)) return wi[n];
    ...
    Ai = function (e, t, n) {
      const {
        ...
        } = t.two.models,
        {
          ...
          return (
            a && !0 === r[o] && ((n = o), (o = a), (a = "")),
            { prefix: n, verb: o, particle: a }
          );
        })(e, t);
      let c = "";
      if ((n || (n = ki(e)), Pi.hasOwnProperty(e))) c = Pi[e];
      else if ("Participle" === n) c = Xa(l, i);
      else if ("PastTense" === n) c = Xa(l, r);
      else if ("PresentTense" === n) c = Xa(l, o);
      else {
  ...
  var zi = {
    ...
    Bi = { noun: yi, verb: Ni, adjective: zi },
    Si = {
      Singular: (e, t, n, r) => {
  ...
  const $i = {
    ...
    Ki = function (e) {
      ...
      return $i.hasOwnProperty(t)
        ? $i[t].find((t) => e.endsWith(t))
        : "s" === t && !Li.find((t) => e.endsWith(t));
    };
  var Ji = {
    two: {
            ...
            (e.forEach((o, a) => {
              t.test(o.post) &&
                (function (e, t) {
                  ...
                  if ("like" === r.normal || o.has(r.normal)) return !1;
                  if (r.tags.has("Place") || r.tags.has("Date")) return !1;
                  if (e[t - 1]) {
                    const n = e[t - 1];
                    if (n.tags.has("Date") || o.has(n.normal)) return !1;
                    if (n.tags.has("Adjective") || r.tags.has("Adjective"))
                      return !1;
                  }
                  const a = r.normal;
                  return (
                    (1 !== a.length && 2 !== a.length && 4 !== a.length) ||
                    !n.test(a)
                  );
                })(e, a + 1) &&
                (n.push(e.slice(r, a + 1)), (r = a + 1));
            }),
  ...
  const Wi = { one: { lexicon: {} }, two: { models: mi } },
    qi = {
      "Actor|Verb": "Actor",
    ...
    Zi = function (e, t) {
      ...
      return (
        Object.keys(e).forEach((o) => {
          ...
          if (
            ((n[o] = qi[a]),
            ("Noun|Verb" !== a && "Person|Verb" !== a && "Actor|Verb" !== a) ||
              Ri(o, r, !1),
            "Adj|Present" === a && (Ri(o, r, !0), Qi(o, r, t)),
          ...
          if (
            (("Noun|Gerund" !== a && "Adj|Noun" !== a && "Person|Noun" !== a) ||
              (function (e, t, n) {
                const r = Ao(e, n);
                t[r] = t[r] || "Plural";
              })(o, r, t),
  ...
  const Xi = function (e, t, n, r) {
      ...
      "-" === e[t].post &&
        e[t + 1] &&
        o([e[t], e[t + 1]], "Hyphenated", r, null, "1-punct-hyphen''");
    },
    Yi = /^(under|over|mis|re|un|dis|semi)-?/,
    es = function (e, t, n) {
      const r = n.two.switches,
        o = e[t];
      if (r.hasOwnProperty(o.normal)) o.switch = r[o.normal];
    ...
    rs = function (e, t, n) {
      ...
      (!(function (e) {
        !e.tags.has("Noun") ||
          e.tags.has("Plural") ||
          e.tags.has("Singular") ||
          ns.find((t) => e.tags.has(t)) ||
          (Ki(e.normal)
            ? ts(e, "Plural", "3-plural-guess")
            : ts(e, "Singular", "3-singular-guess"));
      })(r),
        (function (e) {
          const t = e.tags;
    ...
    cs = { li: !0, dc: !0, md: !0, dm: !0, ml: !0 },
    hs = function (e, t, n) {
      const r = e[t];
      r.index = r.index || [0, 0];
      const o = r.index[1],
        a = r.text || "";
      return 0 !== o && !0 === os.test(a) && !1 === as.test(a)
        ? is.find((e) => r.tags.has(e)) ||
          r.pre.match(/["']$/) ||
          "the" === r.normal
          ? null
          : (rs(e, t, n),
    ...
    gs = function (e, t, n) {
      ...
      if (0 === r.tags.size) {
        ...
        if (null !== e) return (ts(r, e, "2-suffix"), (r.confidence = 0.7), !0);
        if (
          r.implicit &&
          ((e = ds(r.implicit, n.two.suffixPatterns)), null !== e)
        )
          return (ts(r, e, "2-implicit-suffix"), (r.confidence = 0.7), !0);
      }
      return null;
    },
    ms = /['‘’‛‵′`´]/,
    ...
    fs = function (e, t, n, r) {
      ...
      return (
        ...
        d
          ? (o([u], d[1], r, null, `2-regex-'${d[2] || d[0]}'`),
            (u.confidence = 0.6),
            !0)
          : null
      );
    ...
    bs = function (e, t, n) {
      ...
      if (0 === r.tags.size) {
        ...
        if (null !== e) return (ts(r, e, "2-prefix"), (r.confidence = 0.5), !0);
      }
      return null;
    },
    vs = new Set([
    ...
    Ps = function (e, t) {
      ...
      if (
        ...
        if (r && !isNaN(r) && r > 1400 && r < 2100) {
          const o = e[t - 1],
            a = e[t + 1];
          if (ys(o) || ys(a)) return ts(n, "Year", "2-tagYear");
          if (r >= 1920 && r < 2025) {
            if (ws(o) || ws(a)) return ts(n, "Year", "2-tagYear-close");
            if (ks(e[t - 2]) || ks(e[t + 2]))
              return ts(n, "Year", "2-tagYear-far");
            if (
              o &&
              (o.tags.has("Determiner") || o.tags.has("Possessive")) &&
              a &&
              a.tags.has("Noun") &&
              !a.tags.has("Plural")
            )
    ...
    As = function (e, t, n, r) {
      ...
      if (a.tags.has("Verb")) {
        i.find((e) => a.tags.has(e)) ||
          o([a], "Infinitive", r, null, "2-verb-type''");
      }
    },
    Cs = /^[A-Z]('s|,)?$/,
    Ns = /^[A-Z-]+$/,
    ...
    Es = function (e, t, n) {
      ...
      return r.tags.has("RomanNumeral") || r.tags.has("Acronym") || r.frozen
        ...
        : (function (e, t) {
              let n = e.text;
              if (!1 === Ns.test(n)) {
                if (!(n.length > 3 && !0 === js.test(n))) return !1;
                n = n.replace(/s$/, "");
              }
              return !(
                n.length > 5 ||
          ...
          ? (r.tags.clear(),
            ...
            !0)
          : !Ds.hasOwnProperty(r.text) && Cs.test(r.text)
            ? (r.tags.clear(),
              ts(r, ["Acronym", "Noun"], "3-one-letter-acronym"),
              !0)
            : r.tags.has("Organization") && r.text.length <= 3
              ? (ts(r, "Acronym", "3-org-acronym"), !0)
              : r.tags.has("Organization") &&
                  Ns.test(r.text) &&
                  r.text.length <= 6
                ? (ts(r, "Acronym", "3-titlecase-acronym"), !0)
                : null;
    },
    Gs = function (e, t) {
      if (!e) return null;
    ...
    Ms = function (e, t, n) {
      ...
      const r = e.tags;
      return (
        !(r.has("Organization") || r.has("Possessive") || Bs.test(e.normal)) &&
        (!(!r.has("ProperNoun") && !r.has("Place")) ||
          (!(n || ((o = e.text), !/^\p{Lu}[\p{Ll}'’]/u.test(o))) &&
            (0 !== t || r.has("Singular"))))
      );
      var o;
    },
    Ls = function (e, t, n, r) {
      ...
      if (!0 === o[s]) {
        ...
        for (let o = t + 1; o < e.length; o += 1) {
          if (Ms(e[o], o, r))
            return (
              a(e.slice(t, o + 1), "Place", n, null, "3-[foo-place]"),
              !0
            );
          if ("of" !== e[o].normal && !Ss.has(e[o].normal)) break;
        }
      }
      return null;
    },
    Ks = function (e, t, n) {
      ...
      ((0 === o.size ||
        ...
        (r = !0),
        r &&
          (ts(e[t], "Noun", "3-[fallback]"),
          rs(e, t, n),
          (e[t].confidence = 0.1)));
    },
    Js = /^[A-Z][a-z]/,
    Ws = (e, t) =>
      e[t].tags.has("ProperNoun") && Js.test(e[t].text) ? "Noun" : null,
    ...
    Us = {
      ...
      "Person|Adj": (e, t) =>
        (0 === t && e.length > 1) || Ws(e, t) ? "Person" : null,
    },
    Rs =
      "undefined" != typeof process && process.env
        ? process.env
    ...
    _s = (e, t = {}, n) => {
      if (!e || !t) return null;
      const r = Array.from(e.tags).sort((e, t) =>
      ...
      return (
        o &&
          Rs.DEBUG_TAGS &&
          console.log(
            `  [2m[3m      ↓ - '${e.normal || e.implicit}' (#${o})  [0m`
          ),
        (o = t[o]),
        o
      );
    ...
    Xs = function (e, t, n) {
      ...
      if ((Qs.test(l) && !a[l] && (l = l.replace(Qs, "")), s.switch)) {
        ...
        (Us[a] && (u = Us[a](e, t) || u),
          u
            ? (o([s], u, n, null, `3-[switch] (${a})`), rs(e, t, r))
            : Rs.DEBUG_TAGS && console.log(`\n -> X  - '${l}'  : (${a})  `));
      }
    },
    Ys = { there: !0, this: !0, it: !0, him: !0, her: !0, us: !0 },
    el = function (e) {
    ...
    nl = function (e, t, n, r) {
      for (let n = 0; n < e.length; n += 1) {
        let r = Es(e, n, t);
        (rs(e, n, t), (r = r || Fs(e, n, t)), (r = r || Ks(e, n, t)));
      }
      for (let t = 0; t < e.length; t += 1)
        !0 !== e[t].frozen &&
          (zs(e, t, n, r),
      ...
      !(function (e, t) {
        const n = t.methods.one.setTag,
          ...
          o = e[0];
        if (
          ("Noun|Verb" === o.switch || o.tags.has("Infinitive")) &&
          e.length >= 2
        ) {
          if (e.length < 4 && !Ys[e[1].normal]) return;
          if (!o.tags.has("PhrasalVerb") && r.hasOwnProperty(o.normal)) return;
          (e[1].tags.has("Noun") || e[1].tags.has("Determiner")) &&
            ((e.slice(1, 3).some((e) => e.tags.has("Verb")) &&
              !o.tags.has("#PhrasalVerb")) ||
              n([o], "Imperative", t, null, "3-[imperative]"));
        }
      })(e, n);
    },
    rl = {
        ...
        e.docs.forEach((e) => {
          e.forEach((e) => {
            e.penn = (function (e) {
              ...
              const t = e.tagRank || [];
              for (let e = 0; e < t.length; e += 1)
                if (ol.hasOwnProperty(t[e])) return ol[t[e]];
              return null;
            })(e);
          });
        }));
  ...
  const hl = /[,)"';:\-–—.…]/,
      ...
      return "has" ===
        ((e, t) => {
          for (let n = t + 1; n < e.length; n += 1) {
            const t = e[n];
            if (bl.has(t.normal)) return "has";
            if (vl.has(t.normal)) return "is";
            ...
            if ("Adj|Past" === t.switch && e[n + 1]) {
              if (yl.has(e[n + 1].normal)) return "is";
        ...
        : "had" ===
            ((e, t) => {
              for (let n = t + 1; n < e.length; n += 1) {
                ...
                if (Al.has(t.normal)) return "would";
    ...
    Nl = { that: !0, there: !0, let: !0, here: !0, everywhere: !0 },
    jl = { in: !0, by: !0, for: !0 },
    ...
    Hl = {
      ...
      s: (e, t, n) =>
        ((e, t) => {
          const n = e[t];
          if (Nl.hasOwnProperty(n.machine || n.normal)) return !1;
          ...
          if ("Adj|Noun" === r.switch) {
            const n = e[t + 2];
            if (!n) return !1;
            if (Il.has(n.normal)) return !0;
            if (xl.has(n.normal)) return !1;
          }
          if (r.tags.has("Noun")) {
          ...
          if (e[t - 1] && !0 === jl[e[t - 1].normal]) return !0;
          ...
          ? n.methods.one.setTag([e[t]], "Possessive", n, null, "2-contraction")
          : wl(e, t),
    },
    El = function (e, t) {
      const n = t.fromText(e.join(" "));
  ...
  var Sl = {
    postTagger: function (e) {
      ...
      const o = r.two.quickSplit(e.document).map((e) => {
        ...
        a = e.update(o);
      return (a.cache(), a.sweep(Bl), e.uncache(), e.unfreeze(), e);
    },
    tagger: (e) =>
    ...
    lib: {
      lazy: function (e, t) {
        ...
        const r = this.tokenize(e),
          o = Ml(r, n);
        return o.found
          ? (o.compute(["index", "tagger"]), o.match(t))
          : r.none();
      },
    },
  };
        ...
        ? (function (e, t) {
            ...
            return (
              e.forEach((e) => {
                (e.has("#Infinitive") ||
                  (n = (function (e, t) {
                    const n = (0, e.methods.two.transform.verb.conjugate)(
                      t,
                      e.model
                    );
                    return e.has("#Gerund")
          ...
          : o.has("#Adverb")
            ...
            : o.has("#Adjective")
              ? (function (e, t) {
                  ...
                  (e.has("#Comparative")
                    ? (o = n(o, e.model))
                    : e.has("#Superlative") && (o = r(o, e.model)),
                    o && e.replaceWith(o));
                })(o, t)
              : this
    );
  ...
  (h.plugin(cl), h.plugin(Ol), h.plugin($l), h.plugin(Ll), h.plugin(Jl));
  const Wl = function (e) {
  ...
  var Yl = {
      chunks: function (e) {
        ...
        (!(function (e) {
          ...
          (function (e, t, n) {
            const { methods: r } = n;
            ((_l = _l || r.one.buildNet(Zl, n)), e.sweep(_l));
          })(e, 0, n),
          (function (e) {
            for (let t = 0; t < e.length; t += 1)
              for (let n = 0; n < e[t].length; n += 1) {
          ...
          (function (e) {
            ...
            (e.forEach((e) => {
              for (let r = 0; r < e.length; r += 1) {
                const o = e[r];
                n && o.chunk === n
                  ? t[t.length - 1].terms.push(o)
                  : (t.push({ chunk: o.chunk, terms: [o] }), (n = o.chunk));
              }
            }),
              t.forEach((e) => {
                if ("Verb" === e.chunk) {
  ...
  const yu = (e) => e.split("|").reduce((e, t) => ((e[t] = !0), e), {}),
  ...
  const Cu = [
    ...
    Nu = function (e) {
      ...
      for (let t = 0; t < Cu.length; t += 1) if (e.has(Cu[t])) return !0;
      return !1;
    },
    ju = function (e, t) {
    ...
    Iu = (e) => e.text(),
    Tu = (e) => e.json({ terms: !1, normal: !0 }).map((e) => e.normal),
    Du = function (e) {
        ...
        conjugate(e) {
          ...
          return this.getNth(e).map((e) => {
            const n = xu(e),
              ...
              o = { Singular: r };
            return (
              Hu(n.root) && (o.Plural = t.toPlural(r, this.model)),
        ...
        toSingular(e) {
          return this.getNth(e).map((e) =>
            (function (e, t) {
              ...
              return (e.replace(t.root, a, Gu).tag("Singular", "toPlural"), e);
            })(e, xu(e))
          );
        }
        update(e) {
  ...
  const Vu = (e, t) => {
    ...
    zu = function (e) {
      ...
      for (let n = 0; n < e.length; n++) {
        const r = e[n];
        if (!0 === Fu.ones.hasOwnProperty(r)) t += Fu.ones[r];
        else if (!0 === Fu.teens.hasOwnProperty(r)) t += Fu.teens[r];
        else if (!0 === Fu.tens.hasOwnProperty(r)) t += Fu.tens[r];
        else {
    ...
    Su = /^([0-9,. ]+)\/([0-9,. ]+)$/,
    $u = { "a few": 3, "a couple": 2, "a dozen": 12, "two dozen": 24, zero: 0 },
    Mu = (e) => Object.keys(e).reduce((t, n) => (t += e[n]), 0),
    Lu = function (e) {
      if (!0 === $u.hasOwnProperty(e)) return $u[e];
      ...
      for (let e = 0; e < i.length; e++) {
        let s = i[e];
        if (((s = Bu(s)), !s || "and" === s)) continue;
        if ("-" === s || "negative" === s) {
          a = !0;
          continue;
        }
        if (
          ("-" === s.charAt(0) && ((a = !0), (s = s.substring(1))),
          "point" === s)
        )
          return (
            (o += Mu(r)),
        ...
        if (l) {
          ...
          else if (!0 === Fu.ones.hasOwnProperty(s)) r.ones = Fu.ones[s];
          else if (!0 === Fu.teens.hasOwnProperty(s)) r.teens = Fu.teens[s];
          else if (!0 === Fu.tens.hasOwnProperty(s)) r.tens = Fu.tens[s];
          else if (!0 === Fu.multiples.hasOwnProperty(s)) {
            let t = Fu.multiples[s];
            if (t === n) return null;
            if (100 === t && void 0 !== i[e + 1]) {
              const n = i[e + 1];
              Fu.multiples[n] && ((t *= Fu.multiples[n]), (e += 1));
            }
            null === n || t < n
              ? ((o += (Mu(r) || 1) * t), (n = t), (r = {}))
              : ((o += Mu(r)), (n = t), (o = (o || 1) * t), (r = {}));
          }
        }
      }
      return (
    ...
    Wu = { half: 2, halve: 2, quarter: 4 },
    qu = function (e) {
      const t =
        (function (e) {
          const t = e.text("reduced");
          return Wu.hasOwnProperty(t)
            ? { numerator: 1, denominator: Wu[t] }
            : null;
        })((e = e.clone())) ||
        (function (e) {
          const t = e
        ...
        (function (e) {
          ...
          return (
            Ku.test(o) && ((o = o.replace(Ku, "")), (r = r.replaceWith(o))),
        ...
        (function (e) {
          ...
          if (!0 !== t.found) return null;
          if (e.lookAhead("^of .")) return { numerator: 1, denominator: Ju(t) };
          return null;
        })(e) ||
        null;
      return (
    ...
    _u = function (e) {
      ...
      for (let n = 0; n < Ru.length; n++)
        e >= Ru[n][1] && ((e -= Ru[n][1]), t.push(Ru[n][0]));
      ...
      return (
        (n = n.concat(
          ((e) => {
            ...
            n.push("point");
            const o = r[0].split("");
            for (let e = 0; e < o.length; e++) n.push(t[o[e]]);
            return n;
          })(t)
        )),
        (n = n.filter((e) => e)),
          ...
          return (
            this.getNth(e).forEach((e) => {
              let t = (function (e) {
                ...
                const t = Xu({ num: e.numerator });
                let n = ec({ num: e.denominator });
                return (
            ...
            this.getNth(e).forEach((e) => {
              const t = (function (e) {
                return e.numerator && e.denominator
                  ? `${Xu({ num: e.numerator })} out of ${Xu({ num: e.denominator })}`
                  : "";
              })(qu(e));
              e.replaceWith(t);
            }),
    ...
    rc = function (e) {
      ...
      if (
        ...
        t.has("#Value #Value #Value") &&
          !t.has("#Multiple") &&
          t.has("(" + nc + ") #Cardinal #Cardinal") &&
          (t = t.splitAfter("(" + nc + ") #Cardinal")),
        t.has("#Value #Value"))
      ) {
        ...
        if (
          ...
          const n = t.has(
              `(one|two|three|four|five|six|seven|eight|nine) (${nc})`
            ),
            r = e.has("(" + nc + ") #Cardinal"),
        ...
        (t.match("#Ordinal #Ordinal").match("#TextValue").found &&
          !t.has("#Multiple") &&
          (t.has("(" + nc + ") #Ordinal") || (t = t.splitAfter("#Ordinal"))),
        ...
        const o = (function (e, t) {
          ...
          return "" !== o && t.length < 2
            ? ((o = Number(o || e)),
              ...
              ("st" !== a && "nd" !== a && "rd" !== a && "th" !== a) ||
                (a = ""),
              { prefix: r || "", num: o, suffix: a })
            : null;
        })(t, e);
        if (null !== o) return ((o.hasComma = r), (o.unit = n), o);
      }
      let o = e.match("#Fraction{2,}$");
      o = !1 === o.found ? e.match("^#Fraction$") : o;
      let a = null;
      o.found &&
        (o.has("#Value and #Value #Fraction") &&
    ...
    ic = { "%": "percent", "°": "degrees" },
    sc = function (e) {
      const t = { suffix: "", prefix: e.prefix };
      return (
        ...
        set(e) {
          ...
          const t = this.map((t) => {
            ...
            return (
              n.hasComma &&
                "Cardinal" === r &&
                (o = Number(o).toLocaleString()),
              (t = t.not("#Currency")).replaceWith(o, { tags: !0 }),
              t
            );
          });
        ...
        add(e) {
          ...
          const t = this.map((t) => {
            ...
            n.isText &&
              (r = t.has("#Ordinal") ? "TextOrdinal" : "TextCardinal");
            const o = lc(n, r);
            return (t.replaceWith(o, { tags: !0 }), t);
          });
          return new Numbers(t.document, t.pointer);
        }
        subtract(e, t) {
  ...
  const dc = { people: !0, emails: !0, phoneNumbers: !0, places: !0 },
    gc = function (e = {}) {
      return (
        !1 !== (e = Object.assign({}, dc, e)).people &&
    ...
    fc = function (e) {
      ...
      return (
        n.forEach((e, t) => {
          0 !== t || e.has("<Verb>")
            ? o.found || !e.has("<Verb>")
              ? o.found && (a = a.concat(e))
              : (o = e)
            : (r = e);
        }),
        o.found && !r.found && (r = o.before("<Noun>+").first()),
        { subj: r, verb: o, pred: a, grammar: pc(o) }
      );
    };
  var bc = {
    api: function (e) {
  ...
  const vc = function (e) {
    ...
    Pc = function (e, t) {
      ...
      if (n.has("#FemaleName")) return wc;
      if (n.has("#MaleName")) return yc;
      if (r.found) {
        let e = r.text("normal");
        if (((e = e.replace(/\./g, "")), kc.hasOwnProperty(e))) return kc[e];
        if (/^her /.test(e)) return wc;
        if (/^his /.test(e)) return yc;
      }
      const o = t.after();
  ...
  const Nc = function (e, t) {
      const n = { pre: e.none(), post: e.none() };
    ...
    Dc = { tense: "PresentTense" },
    Hc = { conditional: !0 },
    Ec = { tense: "FutureTense" },
    Gc = { progressive: !0 },
    Oc = { tense: "PastTense" },
    Fc = { complete: !0, progressive: !1 },
    Vc = { passive: !0 },
    zc = function (e) {
      const t = {};
      return (
    ...
    Bc = {
      ...
      "want-infinitive": [
        ["^(want|wants|wanted) to #Infinitive$", [Dc]],
        ["^wanted to #Infinitive$", [Oc]],
        ["^will want to #Infinitive$", [Ec]],
      ],
      "gerund-phrase": [
        ["^#PastTense #Gerund$", [Oc]],
        ["^#PresentTense #Gerund$", [Dc]],
        ["^#Infinitive #Gerund$", [Dc]],
        ["^will #Infinitive #Gerund$", [Ec]],
        ["^have #PastTense #Gerund$", [Oc]],
        ["^will have #PastTense #Gerund$", [Oc]],
      ],
      "simple-present": [
        ["^#PresentTense$", [Dc]],
        ["^#Infinitive$", [Dc]],
      ...
      "past-perfect": [
        ["^had #PastTense$", [Oc, Fc]],
        ["^had #PastTense to #Infinitive", [Oc, Fc]],
      ],
      ...
      "passive-past": [
        ["(got|were|was) #Passive", [Oc, Vc]],
        ["^(was|were) being #Passive", [Oc, Vc]],
        ["^(had|have) been #Passive", [Oc, Vc]],
      ],
      "passive-present": [
        ["^(is|are|am) #Passive", [Dc, Vc]],
        ["^(is|are|am) being #Passive", [Dc, Vc]],
        ["^has been #Passive", [Dc, Vc]],
      ],
      "passive-future": [
        ["will have been #Passive", [Ec, Vc, Hc]],
        ["will be being? #Passive", [Ec, Vc, Hc]],
      ],
      "present-conditional": [["would be #PastTense", [Dc, Hc]]],
      "past-conditional": [["would have been #PastTense", [Oc, Hc]]],
      "auxiliary-future": [
        ["(is|are|am|was) going to (#Infinitive|#PresentTense)", [Ec]],
      ],
      "auxiliary-past": [
        ["^did #Infinitive$", [Oc, { plural: !1 }]],
        ["^used to #Infinitive$", [Oc, Fc]],
      ],
      "auxiliary-present": [
        ["^(does|do) #Infinitive$", [Dc, Fc, { plural: !0 }]],
      ],
  ...
  Object.keys(Bc).map((e) => {
    Bc[e].forEach((t) => {
      Sc.push({ name: e, match: t[0], data: zc(t[1]) });
    });
  });
  const $c = function (e, t) {
    ...
    Kc = function (e) {
      const t = (function (e) {
        ...
        if (o.found) return o.nouns();
        let a = n.if("^(that|this|those)");
        return a.found ||
          (!1 === n.found && ((a = t.match("^(that|this|those)")), a.found))
          ? a
          : ((r = n.last()),
            Mc(r) && (n.remove(r), (r = n.last())),
            Mc(r) && (n.remove(r), (r = n.last())),
            r);
      })(e);
      return { subject: t, plural: Lc(t, e) };
    },
    Jc = (e) => e,
    Wc = (e, t) => {
      const n = Kc(e),
    ...
    Qc = function (e, t) {
      ...
      return ((r = n(r, e.model, Rc(e))), r && e.replace(t.root, r), e);
    },
    Zc = (e) =>
    ...
    nh = {
      ...
      simple: (e, t) => {
        const { conjugate: n, toInfinitive: r } = e.methods.two.transform.verb,
          o = t.root;
        if (o.has("#Modal")) return e;
        let a = o.text({ keepPunct: !1 });
        a = r(a, e.model, Rc(o));
        return (
          (a = n(a, e.model).PastTense),
          (a = "been" === a ? "was" : a),
          "was" === a &&
            (a = ((e, t) => {
              const { subject: n, plural: r } = Kc(e);
      ...
      both: function (e, t) {
        return t.negative.found
          ...
          : ((e = nh.simple(e, t)), (e = nh.noAux(e, t)));
      },
      hasHad: (e) => (e.replace("has", "had", th), e),
      hasParticiple: (e, t) => {
        const { conjugate: n, toInfinitive: r } = e.methods.two.transform.verb,
          o = t.root;
        let a = o.text("normal");
        return ((a = r(a, e.model, Rc(o))), n(a, e.model).Participle);
      },
    },
    rh = {
      ...
      "present-progressive": (e) => (
        e.replace("are", "were", th),
        e.replace("(is|are|am)", "was", th),
        e
      ),
      "past-progressive": Jc,
      "future-progressive": (e, t) => (
        e.match(t.root).insertBefore("was"),
        e.remove("(will|be)"),
        e
      ),
      ...
      "passive-past": (e) => (e.replace("have", "had", th), e),
      "passive-present": (e) => (e.replace("(is|are)", "was", th), e),
      "passive-future": (e, t) => (
        t.auxiliary.has("will be") &&
          (e.match(t.root).insertBefore("had been"), e.remove("(will|be)")),
        t.auxiliary.has("will have been") &&
          (e.replace("have", "had", th), e.remove("will")),
        e
      ),
      "present-conditional": (e) => (e.replace("be", "have been"), e),
      "past-conditional": Jc,
      "auxiliary-future": (e) => (e.replace("(is|are|am)", "was", th), e),
      "auxiliary-past": Jc,
      "auxiliary-present": (e) => (e.replace("(do|does)", "did", th), e),
      "modal-infinitive": (e, t) => (
        e.has("can")
          ? e.replace("can", "could", th)
          : (nh.simple(e, t),
      ...
      "modal-past": Jc,
      "want-infinitive": (e) => (
        e.replace("(want|wants)", "wanted", th),
        e.remove("will"),
        e
      ),
      "gerund-phrase": (e, t) => (
        (t.root = t.root.not("#Gerund$")),
        nh.simple(e, t),
        Zc(e),
        e
      ),
    ...
    ah = (e, t) => {
      ...
      if (((i = s.Participle || s.PastTense), i)) {
        e = e.replace(o, i);
        const t = oh(e);
        (e.prepend(t).match(t).tag("Auxiliary"), e.remove(a));
      }
      return e;
    },
    ih = {
    ...
    ch = {
      ...
      "simple-present": (e, t) => {
        const { conjugate: n } = e.methods.two.transform.verb,
          { root: r } = t;
        if (!r.has("#Infinitive")) return lh(e, t);
        {
          const t = Kc(e).subject;
          if (Wc(e) || t.has("i")) return e;
      ...
      "future-progressive": (e) => (
        e.match("will").insertBefore("is"),
        e.remove("be"),
        e.remove("will")
      ),
      "present-perfect": (e, t) => (lh(e, t), (e = e.remove("(have|had|has)"))),
      "past-perfect": (e, t) => {
        const n = Kc(e).subject;
        return Wc(e) || n.has("i")
          ? ((e = Qc(e, t)).remove("had"), e)
          : (e.replace("had", "has", sh), e);
      },
      "future-perfect": (e) => (
        e.match("will").insertBefore("has"),
      ...
      "passive-past": (e, t) => {
        ...
        return e.has("(had|have|has)") && e.has("been")
          ? (e.replace("(had|have|has)", n, sh), e.replace("been", "being"), e)
      ...
      "auxiliary-future": (e, t) => (uh(e, t), e.remove("(going|to)"), e),
      "auxiliary-past": (e, t) => {
        if (t.auxiliary.has("did")) {
          const n = Uc(e);
          return (e.replace(t.auxiliary, n), e);
        }
        return (uh(e, t), e.replace(t.auxiliary, "is"), e);
      },
      ...
      "modal-past": (e, t) => (
        ((e, t) => {
          ...
          ((o = n(o, e.model, Rc(r))), o && (e = e.replace(t.root, o, sh)));
        })(e, t),
        e.remove("have")
      ),
      "gerund-phrase": (e, t) => (
    ...
    mh = {
      ...
      "present-perfect": (e) => (
        e.match("(have|has)").replaceWith("will have"),
        e
      ),
      ...
      "want-infinitive": (e) => (
        e.replace("(want|wants|wanted)", "will want"),
        e
      ),
    },
    ph = { tags: !0 },
    ...
    wh = {
      "simple-present": (e, t) =>
        !0 === yh(e) ? vh(e) : ((e = Qc(e, t)), (e = bh(e))),
      "simple-past": (e, t) =>
        !0 === yh(e) ? vh(e) : ((e = Qc(e, t)).prepend("did not"), e),
      imperative: (e) => (e.prepend("do not"), e),
      infinitive: (e, t) => (!0 === yh(e) ? vh(e) : bh(e)),
      "passive-past": (e) => {
        if (e.has("got"))
          return (e.replace("got", "get", fh), e.prepend("did not"), e);
      ...
      "want-infinitive": (e, t) =>
        (e = (e = bh(e)).replace("wants", "want", fh)),
    };
  var kh = {
    api: function (e) {
      class Verbs extends e {
        ...
        subjects(e) {
          return this.getNth(e).map((e) => (Tc(e), Kc(e).subject));
        }
        adverbs(e) {
          ...
          return this.getNth(e).map((e) => {
            ...
            return (function (e, t) {
              ...
              if (
                ((i = n(i, e.model, Rc(r))),
                i &&
                  e.replace(r, i, eh).tag("Verb").firstTerm().tag("Infinitive"),
                a.found && e.remove(a),
                t.negative.found)
              ) {
          ...
          return this.getNth(e).map((e) => {
            ...
            return n.isInfinitive
              ...
              : (function (e, t) {
                  ...
                  if (s) {
                    const t = qc(e);
                    (e.replace(o, s, ph), e.remove(a), e.prepend(t));
                  }
                  return (
        ...
        toNegative(e) {
          return this.getNth(e).map((e) => {
            ...
            return (function (e, t, n) {
              ...
              if (wh.hasOwnProperty(n)) return wh[n](e, t);
              let r = e.matchOne("be");
              return r.found
                ? (r.prepend("not"), e)
                : !0 === yh(e)
  ...
  const Ph = function (e, t) {
    ...
    jh = function (e, t) {
      ...
      return r.found
        ...
        : ((n = Ah(e)),
          (r = t(n)),
          r.found ? r : ((n = Ah(n)), (r = t(n)), r.found ? r : e.none()));
    };
  var xh = {
    compute: {
        ...
        e.pronouns()
          ...
          .forEach((e) => {
            ...
            (e.has("(he|him|his)")
              ...
              : e.has("(she|her|hers)")
                ? (t = jh(e, (e) => Ch(e, "f")))
                : e.has("(they|their|theirs)") && (t = jh(e, Nh)),
              t &&
                t.found &&
                (function (e, t) {
